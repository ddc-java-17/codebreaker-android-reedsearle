...
public class GuessesAdapter extends ArrayAdapter<Guess> {
  ...
  public GuessesAdapter(@NonNull Context context,
      @NonNull List<Guess> guesses) {
    ...
    guess.getContent()
        .codePoints()
            .forEach((codePoint) -> {
              ...
              //  set content description to the color name corresponding to codePoint
              //  set color filter (tint) to the color value corresponding to the codePoint
